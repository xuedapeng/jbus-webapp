...
public class Md5SaltTool {
     ...
     */  
    public static boolean validPassword(String password, String passwordDigest)  {   
        //将16进制字符串格式口令转换成字节数组   
        byte[] pwdInDb = hexStringToByte(passwordDigest);   
        //声明盐变量   
    ...
    public static String getEncryptedPwd(String password) {   
        ...
        pwdDigest = new byte[digest.length + SALT_LENGTH];   
        //将盐的字节拷贝到生成的加密口令字节数组的前12个字节，以便在验证口令时取出盐   
        System.arraycopy(salt, 0, pwdDigest, 0, SALT_LENGTH);   
    ...
    public static void main(String[] args) {
    	...
    	String digest = Md5SaltTool.getEncryptedPwd(password);
    	System.out.println();
    	System.out.println(digest);
    	
    	boolean v = Md5SaltTool.validPassword(password, digest);
